...
export declare function mapRow<T>(row: Record<string, unknown>, mapping: Record<string, string>): T;
/** Default: pass through row keys (DB uses snake_case matching our entities). */
export declare function mapRowDefault<T>(row: Record<string, unknown>): T;
