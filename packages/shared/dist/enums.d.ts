...
/** Trace span type */
export type TraceSpanType = 'policy_evaluation' | 'validation' | 'approval' | 'downstream_call';
/** Proposal status */
export type ProposalStatus = 'pending' | 'approved' | 'rejected' | 'committed';
/** Approval request status */
export type ApprovalRequestStatus = 'pending' | 'approved' | 'denied' | 'expired' | 'awaiting-info';
/** Validation check type */
export type ValidationCheckType = 'schema' | 'pii' | 'sentiment' | 'business-rule' | 'format';
...
export type PolicyDecisionType = 'allow' | 'deny' | 'allow-with-validation' | 'allow-with-approval';
